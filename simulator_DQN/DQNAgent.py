...
class DQNAgent:
    def __init__(self, state_size, action_size, name="distancesquared_DQNAgent", path="./save/", memory_buffer=10000,   \
    ...
    def _build_model(self):
        ...
        if self.model_type == 0:
            ...
            inputs = Input(shape=(self.state_size[1], self.state_size[2], self.state_size[3]))
