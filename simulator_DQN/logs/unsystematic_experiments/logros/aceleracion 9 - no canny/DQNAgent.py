...
class DQNAgent:
    ...
    gamma=0.999, epsilon=1, epsilon_min=0.1, epsilon_decay=0.9997,     \
    learning_rate=0.0005, learning_rate_decay=0.0, tau_max=250,        \
    ...
    def _build_model(self):
        ...
        if self.model_type == 0:
            ...
            inputs1 = Input(shape=(self.state_size[1], self.state_size[2], 1), name="image")
            crop = Cropping2D(cropping=((40,0),(0,0)))(inputs1)
            conv = Conv2D(filters=8, kernel_size=(3, 3), strides=(2, 2), kernel_initializer="he_normal")(crop)
            conv = LeakyReLU(alpha=0.4)(conv)
