...
from keras.layers import Input, Lambda, Convolution2D, MaxPooling2D, Cropping3D, Conv3D, MaxPooling3D, BatchNormalization, LeakyReLU
...
class DQNAgent:
    ...
    gamma=0.99, epsilon=1, epsilon_min=0.02, epsilon_decay=0.999,     \
    learning_rate=0.01, learning_rate_decay=0.0, tau_max=100,        \
    batch_size=64, upgrade_mode=0, model_type=0):
