...
const char* ssid = "JAZZTEL_hre6";
const char* password = "47mqsd4stdqs";

//Web/Server address to read/write from 
const char* host = "192.168.1.134";   //https://circuits4you.com website or IP address of server
...
void setup() {
  ...
  String Link = "http://192.168.1.134:5000/";
