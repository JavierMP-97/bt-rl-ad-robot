...
# Action repeat
FRAME_SKIP = 1
Z_SIZE = 32  # Only used for random features
TEST_FRAME_SKIP = 1
...
os.environ['DONKEY_SIM_PATH'] = "D:\\TFG\\Nueva carpeta 2\\DonkeySim.exe"
